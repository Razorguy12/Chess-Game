 ...
 * @brief Implements special chess rules such as castling, en passant, and pawn promotion.
 */

#include "SpecialMoves.h"

/**
 * @brief Determines whether a player can legally perform king-side castling.
 *
 * Conditions checked:
 * - King and rook exist and have not moved.
 ...
 * @return true if king-side castling is legal.
...
/**
 * @brief Determines whether a player can legally perform queen-side castling.
 *
 * Conditions checked:
 * - King and rook exist and have not moved.
 * - Path between king and rook is empty.
 ...
 * @param board Reference to the game board.
 * @return true if queen-side castling is legal.
 * @return false otherwise.
 */
...
/**
 * @brief Executes castling move on the board.
 *
 * Assumes castling legality has already been checked by 
 * canCastleKingSide() or canCastleQueenSide().
 *
...
/**
 * @brief Promotes a pawn into another piece chosen by the user.
 *
 * Allowed choices:
 * - 'Q'/'q': Queen  
 * - 'R'/'r': Rook  
 * - 'B'/'b': Bishop  
 * - 'N'/'n': Knight  
 * If input is invalid, defaults to a Queen.
 *
 * @param pos Position of the pawn being promoted.
 * @param choice Character representing the new piece.
 * @param board Reference to the game board.
 */
...
/**
 * @brief Determines whether a pawn's move qualifies as en passant.
 *
 * Conditions:
 * - Moving piece must be a pawn.
 * - Board must have an active en passant target.
 * - Destination must match the en passant target.
 *
...
/**
 * @brief Executes an en passant capture.
 *
 * Steps performed:
 * - Removes the captured pawn located behind the target square.
 * - Moves the attacking pawn into the en passant target square.
 *
 * @param from Starting position of the attacking pawn.
 * @param to En passant capture square.
